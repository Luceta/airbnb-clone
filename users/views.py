...
def kaokao_login(request):
    app_key = os.environ.get("KAOKAO_KEY")
    redirect_url = "https://127.0.0.1:8000/users/login/kaokao/callback"
    return redirect(
        f"https://kauth.kakao.com/oauth/authorize?response_type=code&client_id={app_key}&redirect_uri={redirect_url}"
    )
